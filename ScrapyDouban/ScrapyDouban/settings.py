...
#生成文件名
MOIVE_NAME = "yichuhaoxi"
# 配置mongoDB
MONGO_HOST = "127.0.0.1"  # 主机IP
MONGO_PORT = 27017  # 端口号
MONGO_DB = "douban"  # 库名
MONGO_COLL = "yichuhaoxi"  # collection
...
DOWNLOADER_MIDDLEWARES = {
   #'tutorial.middlewares.MyCustomDownloaderMiddleware': 543,
    ...
    #'ScrapyDouban.middlewares.IPPOOlS' : 3,
    'scrapy.contrib.downloadermiddleware.useragent.UserAgentMiddleware': 2,
    'ScrapyDouban.uamid.Uamid': 1
}
...
ITEM_PIPELINES = {
   ...
   # 预留MongoDB存储类
    'ScrapyDouban.pipelines.GetDoubanMongo': 300,
   #'ScrapyDouban.pipelines.JsonWritePipline': 300
}
